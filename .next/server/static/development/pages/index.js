...
/* harmony import */ var antd_lib_message_style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! antd/lib/message/style/css */ "antd/lib/message/style/css");
...
/* harmony import */ var antd_lib_popconfirm_style_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! antd/lib/popconfirm/style/css */ "antd/lib/popconfirm/style/css");
...
/* harmony import */ var antd_lib_popconfirm__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! antd/lib/popconfirm */ "antd/lib/popconfirm");
...
/* harmony import */ var antd_lib_affix_style_css__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! antd/lib/affix/style/css */ "antd/lib/affix/style/css");
...
/* harmony import */ var antd_lib_affix__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! antd/lib/affix */ "antd/lib/affix");
...
/* harmony import */ var antd_lib_menu_style_css__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! antd/lib/menu/style/css */ "antd/lib/menu/style/css");
...
/* harmony import */ var antd_lib_menu__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! antd/lib/menu */ "antd/lib/menu");
...
/* harmony import */ var antd_lib_button_style_css__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! antd/lib/button/style/css */ "antd/lib/button/style/css");
...
/* harmony import */ var antd_lib_button__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! antd/lib/button */ "antd/lib/button");
...
/* harmony import */ var antd_lib_select_style_css__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! antd/lib/select/style/css */ "antd/lib/select/style/css");
/* harmony import */ var antd_lib_select_style_css__WEBPACK_IMPORTED_MODULE_20___default = /*#__PURE__*/__webpack_require__.n(antd_lib_select_style_css__WEBPACK_IMPORTED_MODULE_20__);
/* harmony import */ var antd_lib_select__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! antd/lib/select */ "antd/lib/select");
...
function (_Component) {
  ...
  function _default() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "boxadd", function () {
      ...
      var _arr = Object.keys(datacollection);

      for (var _i = 0; _i < _arr.length; _i++) {
        var key = _arr[_i];

        if (!_this.state.exchangeboxes.includes(key)) {
          T.push(key);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "exchangeChange", function (boxkey, value) {
      ...
      switch (value) {
        case 'BINANCE':
          fetch('/binance-depth/' + datacollection[value][0].replace('/', '')).then(function (res) {
            return res.json();
          }).then(function (data) {
            return _this.setState(_defineProperty({}, value + datacollection[value][0].replace('/', '_'), data));
          });
          break;

        case 'BTCTURK':
          Promise.all([fetch('https://www.btcturk.com/api/orderbook?pairSymbol=' + datacollection[value][0].replace('/', '')), fetch('https://www.btcturk.com/api/trades?pairSymbol=' + datacollection[value][0].replace('/', '') + '&last=18')]).then(function (_ref) {
        ...
        case 'KOINEKS':
          fetch('https://cors.io/?https://koineks.com/ticker').then(function (res) {
            return res.json();
          }).then(function (data) {
            return _this.setState(_defineProperty({}, value + datacollection[value][0].replace('/', '_'), data));
          });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "parityChange", function (boxkey, value) {
      var P = _this.state.parities;
      P[boxkey] = value;
      ...
      switch (_this.state.exchangeboxes[boxkey]) {
        case 'BINANCE':
          fetch('/binance-depth/' + value.replace('/', '')).then(function (res) {
            return res.json();
          }).then(function (data) {
            return _this.setState(_defineProperty({}, _this.state.exchangeboxes[boxkey] + value.replace('/', '_'), data));
          });
          break;

        case 'BTCTURK':
          Promise.all([fetch('https://www.btcturk.com/api/orderbook?pairSymbol=' + value.replace('/', '')), fetch('https://www.btcturk.com/api/trades?pairSymbol=' + value.replace('/', '') + '&last=18')]).then(function (_ref5) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "fiveInterval", function () {
      ...
      for (var _i2 = 0; _i2 < array.length; _i2++) {
        ...
        for (var _i4 = 0; _i4 < uniquearray.length; _i4++) {
          var subitem = uniquearray[_i4];
        ...
        if (isItem) {
          uniquearray.push(_defineProperty({}, key, value));
        }
      }

      var _loop = function _loop() {
        var item = uniquearray[_i3];
        var key = Object.keys(item)[0];
        var value = item[key].replace('/', '');

        switch (key) {
          case 'BINANCE':
            fetch('/binance-depth/' + value).then(function (res) {
              return res.json();
            }).then(function (data) {
              return _this.setState(_defineProperty({}, 'BINANCE' + item[key].replace('/', '_'), data));
            });
            break;

          case 'BTCTURK':
            Promise.all([fetch('https://www.btcturk.com/api/orderbook?pairSymbol=' + value), fetch('https://www.btcturk.com/api/trades?pairSymbol=' + value + '&last=18')]).then(function (_ref9) {
          ...
          case 'KOINEKS':
            fetch('https://cors.io/?https://koineks.com/ticker').then(function (res) {
              ...
              return _this.setState(_defineProperty({}, 'KOINEKS' + item[key].replace('/', '_'), data));
            });
            break;
        }
      };

      for (var _i3 = 0; _i3 < uniquearray.length; _i3++) {
        _loop();
      }
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentDidMount", function () {
      Promise.all([fetch('/binance-depth/' + datacollection['BINANCE'][0].replace('/', '')), fetch('https://www.btcturk.com/api/orderbook?pairSymbol=' + datacollection['BTCTURK'][0].replace('/', '')), fetch('https://www.btcturk.com/api/trades?pairSymbol=' + datacollection['BTCTURK'][0].replace('/', '') + '&last=18'), fetch('https://cors.io/?https://koineks.com/ticker')]).then(function (_ref13) {
...
var Pie = function Pie(props) {
  ...
  startAngle = 0;
  return react__WEBPACK_IMPORTED_MODULE_22___default.a.createElement("svg", {
    width: diameter,
    height: diameter,
    ...
    startAngle += angle;
    return react__WEBPACK_IMPORTED_MODULE_22___default.a.createElement(Slice, {
      key: sliceIndex,
      key1: sliceIndex,
      value: slice,
...
function (_React$Component2) {
  ...
  function Slice() {
    ...
    _this3 = _possibleConstructorReturn(this, (_getPrototypeOf3 = _getPrototypeOf(Slice)).call.apply(_getPrototypeOf3, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this3)), "componentWillReceiveProps", function () {
      _this3.setState({
        path: ''
      });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this3)), "componentDidMount", function () {
      _this3.animate();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this3)), "animate", function () {
      _this3.draw(0);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this3)), "draw", function (s) {
      var p = _this3.props,
          path = [],
          a,
          b,
          c,
          self = _assertThisInitialized(_assertThisInitialized(_this3)),
          step;
  ...
  _createClass(Slice, [{
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_22___default.a.createElement("g", {
        overflow: "hidden"
      }, react__WEBPACK_IMPORTED_MODULE_22___default.a.createElement("path", {
        d: this.state.path,
        fill: this.props.fill,
        stroke: this.props.stroke,
        strokeWidth: this.props.strokeWidth ? this.props.strokeWidth : 3
      }), this.props.showLabel && this.props.percentValue > 5 ? react__WEBPACK_IMPORTED_MODULE_22___default.a.createElement("text", {
        x: this.state.x,
        y: this.state.y,
        fill: "#fff",
        textAnchor: "middle"
      }, this.props.key1 == 1 ? this.props.value + '$' : 'BTC') : null);
    }
  }]);
