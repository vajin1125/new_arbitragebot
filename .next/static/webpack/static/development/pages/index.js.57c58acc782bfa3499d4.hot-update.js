      ...
      for (var i = 0; i < _this.state.exchangeboxes.length; i++) {
        ...
        switch (_this.state.exchangeboxes[i]) {
          ...
          case 'KOINEKS':
            ...
            var b = a[0];
            T[i] = [5000, parseFloat(_this.state['KOINEKS' + parity][b].current)];
            console.log(_this.state['KOINEKS' + parity][b]);
            break;
        }
...
//# sourceMappingURL=index.js.57c58acc782bfa3499d4.hot-update.js.map