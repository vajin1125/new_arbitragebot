    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "fiveInterval", function () {
      ...
      for (var i = 0; i < _this.state.exchangeboxes.length; i++) {
        ...
        switch (_this.state.exchangeboxes[i]) {
          case 'BINANCE':
            T[0] = [5000, parseFloat(Object.keys(_this.state['BINANCE' + parity].depth.bids)[7])];
            break;

          case 'BTCTURK':
            T[0] = [5000, parseFloat(_this.state['BTCTURK' + parity].bids[7][0])];
            break;
...
//# sourceMappingURL=index.js.a3c99fe6c51b192c0043.hot-update.js.map