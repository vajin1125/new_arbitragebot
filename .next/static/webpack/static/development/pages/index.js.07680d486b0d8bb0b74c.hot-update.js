    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "fiveInterval", function () {
      ...
      for (var i = 0; i < _this.state.exchangeboxes.length; i++) {
        ...
        switch (_this.state.exchangeboxes[i]) {
          case 'BINANCE':
            // T[i] = [5000, (parseFloat(Object.keys(this.state['BINANCE' + parity].depth.bids)[5]) + parseFloat(Object.keys(this.state['BINANCE' + parity].depth.bids)[6]) + parseFloat(Object.keys(this.state['BINANCE' + parity].depth.bids)[7]))/3];
            break;

          case 'BTCTURK':
            // T[i] = [5000, (parseFloat(this.state['BTCTURK' + parity].bids[5][0]) + parseFloat(this.state['BTCTURK' + parity].bids[6][0]) + parseFloat(this.state['BTCTURK' + parity].bids[7][0]))/3];
            break;
...
//# sourceMappingURL=index.js.07680d486b0d8bb0b74c.hot-update.js.map