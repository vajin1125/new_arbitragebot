...
var Pie = function Pie(props) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_22___default.a.createElement("svg", {
    ...
    version: "1.1"
  }, _this3.props.data.map(function (slice, sliceIndex) {
    var angle, nextAngle, percent;
    nextAngle = startAngle;
    angle = slice / sum * 360;
    percent = slice / sum * 100;
    startAngle += angle;
    return react__WEBPACK_IMPORTED_MODULE_22___default.a.createElement("div", null, slice);
    /*return <Slice
    	key={ sliceIndex }
    	value={ slice }
...
//# sourceMappingURL=index.js.cc196c87348778d6c1ca.hot-update.js.map