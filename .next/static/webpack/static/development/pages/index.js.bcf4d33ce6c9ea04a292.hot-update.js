...
function (_Component) {
  ...
  function _default() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "fiveInterval", function () {
      ...
      if (_this.state.piedata) {
        var T = _this.state.piedata;
        T[1] = parseFloat(Object.keys(_this.state.BINANCEBTC_USDT.depth.bids)[7]);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentDidMount", function () {
      ...
      if (_this.state.BINANCEBTC_USDT) _this.setState({
        piedata: [5000, parseFloat(Object.keys(_this.state.BINANCEBTC_USDT.depth.bids)[7])]
      });
    });
...
//# sourceMappingURL=index.js.bcf4d33ce6c9ea04a292.hot-update.js.map