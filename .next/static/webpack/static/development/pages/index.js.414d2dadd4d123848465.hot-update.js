    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "fiveInterval", function () {
      ...
      for (var i = 0; i < _this.state.exchangeboxes.length; i++) {
        ...
        switch (_this.state.exchangeboxes[i]) {
          case 'BINANCE':
            T[i] = [5000, ((parseFloat(Object.keys(_this.state['BINANCE' + parity].depth.bids)[5]) + parseFloat(Object.keys(_this.state['BINANCE' + parity].depth.bids)[6]) + parseFloat(Object.keys(_this.state['BINANCE' + parity].depth.bids)[7])) / 3).toFixed(2)];
            break;

          case 'BTCTURK':
            T[i] = [5000, (parseFloat(_this.state['BTCTURK' + parity].bids[5][0]).toFixed(2) + parseFloat(_this.state['BTCTURK' + parity].bids[6][0]).toFixed(2) + parseFloat(_this.state['BTCTURK' + parity].bids[7][0]).toFixed(2)) / 3];
            break;
...
//# sourceMappingURL=index.js.414d2dadd4d123848465.hot-update.js.map