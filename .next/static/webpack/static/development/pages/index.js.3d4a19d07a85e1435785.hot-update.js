    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "fiveInterval", function () {
      ...
      for (var i = 0; i < _this.state.exchangeboxes.length; i++) {
        ...
        switch (_this.state.exchangeboxes[i]) {
          ...
          case 'BTCTURK':
            T[i] = [5000, ((parseFloat(_this.state['BTCTURK' + parity].bids[5][0]) + parseFloat(_this.state['BTCTURK' + parity].bids[6][0]) + parseFloat(_this.state['BTCTURK' + parity].bids[7][0])) / 3).toFixed(2)];
            break;
...
//# sourceMappingURL=index.js.3d4a19d07a85e1435785.hot-update.js.map