    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "fiveInterval", function () {
      ...
      for (var i = 0; i < _this.state.exchangeboxes.length; i++) {
        ...
        switch (_this.state.exchangeboxes[i]) {
          case 'BINANCE':
            T[i] = [5000, (parseFloat(Object.keys(_this.state['BINANCE' + parity].depth.bids)[5]) + parseFloat(Object.keys(_this.state['BINANCE' + parity].depth.bids)[6]) + parseFloat(Object.keys(_this.state['BINANCE' + parity].depth.bids)[7])) / 3];
            break;
...
//# sourceMappingURL=index.js.7366b2c040c14ca706a9.hot-update.js.map