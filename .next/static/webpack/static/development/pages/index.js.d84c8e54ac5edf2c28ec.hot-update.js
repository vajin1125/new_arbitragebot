  ...
  function _default() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "boxadd", function () {
      ...
      for (var _i = 0; _i < _arr.length; _i++) {
        ...
        if (!_this.state.exchangeboxes.includes(_key2)) {
          T.push(_key2);
          P.push(datacollection[_key2][0]);
          isNew = true;
          break;
        }
      }
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "fiveInterval", function () {
      ...
      for (var i = 0; i < _this.state.exchangeboxes.length; i++) {
        ...
        switch (key) {
          case 'BINANCE':
            ...
            T[0] = [5000, parseFloat(Object.keys(_this.state.BINANCEBTC_USDT.depth.bids)[7])];
      ...
      for (var _i2 = 0; _i2 < array.length; _i2++) {
        ...
        var value = item[_key3];
        var isItem = true;

        for (var _i4 = 0; _i4 < uniquearray.length; _i4++) {
          var subitem = uniquearray[_i4];

          if (Object.keys(subitem)[0] === _key3 && subitem[Object.keys(subitem)[0]] === value) {
            isItem = false;
            break;
          }
        }
        ...
        if (isItem) {
          uniquearray.push(_defineProperty({}, _key3, value));
        }
      }
...
//# sourceMappingURL=index.js.d84c8e54ac5edf2c28ec.hot-update.js.map