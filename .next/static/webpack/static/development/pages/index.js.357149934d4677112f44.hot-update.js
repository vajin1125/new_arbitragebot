    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "fiveInterval", function () {
      ...
      for (var i = 0; i < _this.state.exchangeboxes.length; i++) {
        ...
        switch (_this.state.exchangeboxes[i]) {
          ...
          case 'BTCTURK':
            T[i] = [5000, (parseFloat(_this.state['BTCTURK' + parity].bids[5][0]).toFixed(2) + parseFloat(_this.state['BTCTURK' + parity].bids[6][0]) + parseFloat(_this.state['BTCTURK' + parity].bids[7][0])) / 3];
            break;
...
//# sourceMappingURL=index.js.357149934d4677112f44.hot-update.js.map