        ...
        switch (key) {
          case 'BINANCE':
            fetch('/binance-depth/' + value).then(function (res) {
              ...
              return _this.setState(_defineProperty({}, 'BINANCE' + item[key].replace('/', '_'), data), function () {
                var T = _this.state.piedata; // T[1] = Object.keys(data.depth.bids)[0];

                console.log(Object.keys(data.depth.bids)[0]);
...
//# sourceMappingURL=index.js.5139c9690833aad9758e.hot-update.js.map