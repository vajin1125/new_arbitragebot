...
var Paritybox = function Paritybox(props) {
  return react__WEBPACK_IMPORTED_MODULE_26___default.a.createElement(antd_lib_row__WEBPACK_IMPORTED_MODULE_11___default.a, {
    ...
    dataSource: _this.state.filterdata,
    style: {
      width: 200
    } // onSelect={onSelect}
    ,
    onSearch: _this.autocomplete
  }, "style", {
    width: '48.9%',
    float: 'right',
    marginTop: 3,
...
function (_Component) {
  ...
  function _default() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "add", function (e) {
      antd_lib_message__WEBPACK_IMPORTED_MODULE_5___default.a.success('A new box added');
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "confirm", function () {
      antd_lib_message__WEBPACK_IMPORTED_MODULE_5___default.a.success('Okay. will delete it');
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "autocomplete", function (value) {
...
//# sourceMappingURL=parity.js.6233c54cdd9a58b36f79.hot-update.js.map